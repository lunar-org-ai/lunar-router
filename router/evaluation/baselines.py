...
Every evaluation should include these baselines to contextualize how
the router is performing relative to trivial strategies.
"""
...
class RandomBaseline:
    """Uniformly random model selection — the straight-line baseline."""
...
class OracleBaseline:
    """Always picks the cheapest *correct* model — theoretical upper bound."""
...
class AlwaysStrongBaseline:
    """Always picks the most-accurate model — quality ceiling at max cost."""
...
class AlwaysWeakBaseline:
    """Always picks the cheapest model — cost floor at minimum quality."""
