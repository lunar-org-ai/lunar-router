"""
Weights management for Lunar Router.
...
from .hub import Hub, LUNAR_DATA_HOME, download as hub_download, path as hub_path
...
def download_weights(
    ...
    Example:
        >>> from lunar_router.weights import download_weights
...
def download_from_s3(
    ...
    try:
        ...
        raise ImportError(
            ...
            "Install with: pip install lunar-router[s3]"
        )

    if dest is None:
        filename = key.rsplit("/", 1)[-1]
        dest = LUNAR_DATA_HOME / "custom" / filename
